<%@ Page Title="Method Of Delivery" Language="C#" MasterPageFile="~/Application/Common/Common.Master"
    AutoEventWireup="true" CodeFile="Master_MethodOfDelivery.aspx.cs" Inherits="DhiiLifeSpring.Application.Masters.Master_MethodOfDelivery"
...
<asp:Content ID="Content2" ContentPlaceHolderID="bodyContentPlaceHolder" runat="server">
    <script type="text/javascript" language="javascript">
        ...
        function onModalPopupShown() {
            $get("<%=txtMethodOfDelivery.ClientID%>").focus();
        }
        function onKeyDown(e) {
            if (e && e.keyCode == Sys.UI.Key.esc) {
                $find('mdlPopup').hide();
                document.getElementById('<%=btnAddMethodOfDelivery.ClientID %>').focus();
            }
        }
        function AddClick() {
            var msg = document.getElementById('<%=lblMsg.ClientID %>');
            if (document.getElementById('<%=txtMethodOfDelivery.ClientID%>').value.trim() == "") {
                msg.innerHTML = "Required method of delivery";
                msg.style.color = "red";
                document.getElementById('<%=txtMethodOfDelivery.ClientID%>').focus();
                return false;
            }
        ...
        <ContentTemplate>
                                        ...
                                        <table width="100%" style="text-align: center">
                                            <tr>
                                                <td valign="middle" class="mdpopup-header">
                                                    <asp:Label ID="lblmdlheadertext" runat="server" Text="Add/Update Method Of Delivery"></asp:Label>
                                                </td>
                                            </tr>
                                            <tr>
                                                    ...
                                                    <table width="80%" align="center">
                                                        ...
                                                        <tr>
                                                            <td align="left" style="padding-top: 5px;">
                                                                <span class="star">*</span><asp:Label ID="lblMethodOfDelivery" runat="server" Text="Method Of Delivery:"></asp:Label>
                                                            </td>
                                                            <td align="left" style="padding-top: 5px;">
                                                                <asp:TextBox ID="txtMethodOfDelivery" runat="server" SkinID="Txt_Skin" MaxLength="50"
                                                                    onfocus="Change(this, event)" onblur="Change(this, event)" onkeyup="return CheckFirstChar(this);"></asp:TextBox>
                                                                <ajaxToolkit:FilteredTextBoxExtender ID="fteMethodOfDelivery" runat="server" TargetControlID="txtMethodOfDelivery"
            ...
            <fieldset style="border: 1px dashed #ccc; margin-left: 10px; margin-top: 0px; text-align: right;
                ...
                <legend class="legend_right" style="margin-right: 10px;" align="right">
                    <asp:Label ID="lblDoc" runat="server" Text="Method Of Delivery"></asp:Label>
                </legend>
                <table width="100%">
                    <tr>
                        <td align="center">
                            <table width="98%" style="text-align: center;" cellpadding="0" cellspacing="0">
                                <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <ajaxToolkit:AutoCompleteExtender ID="aceSearch" runat="server" BehaviorID="bidSearch"
                                                        ...
                                                        CompletionSetCount="20" MinimumPrefixLength="1" ServiceMethod="GetAllMethodOfDelivery"
                                                    ...
                                                    <ajaxToolkit:TextBoxWatermarkExtender ID="wmeSearch" runat="server" TargetControlID="txtSearch"
                                                        WatermarkCssClass="watermarked" WatermarkText="Method Of Delivery">
                                    ...
                                    <td align="right" style="padding-bottom: 10px">
                                        <asp:Button ID="btnAddMethodOfDelivery" runat="server" CssClass="button_Add" Text="Add New"
                                            ToolTip="Add New" CausesValidation="False" OnClick="btnAddMethodOfDelivery_Click"
                                             />
                                    </td>
                                </tr>
                                <tr>
                                    <td align="center" colspan="2">
                                        <asp:GridView ID="gvMethodOfDelivery" runat="server" AutoGenerateColumns="False"
                                            AllowPaging="True" AllowSorting="True" EmptyDataText="No Records Found" OnPageIndexChanging="gvMethodOfDelivery_PageIndexChanging"
                                            OnRowCommand="gvMethodOfDelivery_RowCommand" OnRowDataBound="gvMethodOfDelivery_RowDataBound"
                                            OnSorting="gvMethodOfDelivery_Sorting" PageSize="15" SkinID="GridMasters" Width="100%">
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Method Of Delivery" SortExpression="MethodOfDelivery">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblMethodOfDeliveryName" runat="server" Text='<%# Eval("MethodOfDelivery") %>'></asp:Label>
                                                    </ItemTemplate>
                                                ...
                                                <asp:TemplateField HeaderText="Edit">
                                                    <ItemTemplate>
                                                        <asp:ImageButton ID="lnkedit" runat="server" CausesValidation="False" CommandArgument='<%# Eval("MethodOfDeliveryId") %>'
                                        ...
                                        <asp:HiddenField ID="hfMethodOfDeliveryId" runat="server" />
