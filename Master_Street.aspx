<%@ Page Title="Street" Language="C#" MasterPageFile="~/Application/Common/Common.Master"
    AutoEventWireup="true" CodeFile="Master_Street.aspx.cs" Inherits="DhiiLifeSpring.Application.Masters.Master_Street"
    ...
    <script type="text/javascript" language="javascript">
        ...
        function onKeyDown(e) {
            if (e && e.keyCode == Sys.UI.Key.esc) {
                $find('mdlPopup').hide();
                document.getElementById('<%=btnAddStreet.ClientID %>').focus();
            }
        }
        function AddClcik() {
            ...
            if (document.getElementById('<%=txtStreet.ClientID %>').value.trim() == "") {
                msg.innerHTML = "Required street";
                msg.style.color = "red";
        ...
        <ContentTemplate>
                                        ...
                                        <table width="100%" style="text-align: center">
                                            <tr>
                                                <td valign="middle" class="mdpopup-header">
                                                    <asp:Label ID="lblmdlheadertext" runat="server" Text=" Add/Update Street"></asp:Label>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="center">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="left" style="padding-top: 5px;">
                                                                <asp:DropDownList ID="ddlCity" runat="server" 
                                                                    SkinID="Dpd_Skin" onfocus="Change(this, event)" onblur="Change(this, event)"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="left" style="padding-top: 5px;">
                                                                <asp:DropDownList ID="ddlMunicipalWard" runat="server" SkinID="Dpd_Skin" onfocus="Change(this, event)"
                                                                    onblur="Change(this, event)" AutoPostBack="True" OnSelectedIndexChanged="ddlMunicipalWard_SelectedIndexChanged">
                                                                </asp:DropDownList>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td align="left" style="padding-top: 5px;">
                                                                <asp:DropDownList ID="ddlColony"  runat="server"
                                                                    SkinID="Dpd_Skin" onblur="Change(this, event)">
                                                                </asp:DropDownList>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td align="left" style="padding-top: 5px;">
                                                                <asp:TextBox ID="txtStreet" runat="server" onfocus="Change(this, event)" onblur="Change(this, event)"
                                                                    onkeyup="return CheckFirstChar(this);" onkeydown="return CheckFirstChar(this);"
                                                                    MaxLength="50" SkinID="Txt_Skin"></asp:TextBox>
                                                                <ajaxToolkit:FilteredTextBoxExtender ID="fteStreet" runat="server" FilterMode="InvalidChars"
                                                                    TargetControlID="txtStreet" InvalidChars=";|~!@#$%^&'*<>/\{}:';/*-+_?~`()[]=,.1234567890&quot;"
                                                                    Enabled="True">
                                                        ...
                                                        <tr>
                                                            <td align="center" colspan="2" style="padding-top: 10px;">
                                                                <div class="base">
                                                                    ...
                                                                    <asp:Button ID="btnClear" runat="server" Text="Clear" CausesValidation="False" ToolTip="Clear"
            ...
            <fieldset style="border: 1px dashed #ccc; margin-left: 10px; margin-top: 0px; text-align: right;
                ...
                <legend class="legend_right" style="margin-right: 10px;" align="right">
                    <asp:Label ID="lblDoc" runat="server" Text=" Street"></asp:Label>
                </legend>
                <table width="100%">
                    <tr>
                        <td align="center">
                                ...
                                <caption>
                                    <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <ajaxToolkit:AutoCompleteExtender ID="ae1" runat="server" BehaviorID="AutoCompleteEx"
                                                            ...
                                                            CompletionSetCount="20" MinimumPrefixLength="1" ServiceMethod="GetAllStreets"
                                                        ...
                                                        <ajaxToolkit:TextBoxWatermarkExtender ID="txtwSearch" runat="server" TargetControlID="txtSearch"
                                                            WatermarkCssClass="watermarked" WatermarkText="Street" Enabled="True">
                                        ...
                                        <td align="right" style="padding-bottom: 10px">
                                            <asp:Button ID="btnAddStreet" runat="server" CausesValidation="False" CssClass="button_Add"
                                                 OnClick="btnAddStreet_Click" Text="Add New"
                                                ToolTip="Add New" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="center" colspan="2">
                                            <asp:GridView ID="gvStreet" runat="server" AllowPaging="True" AllowSorting="True"
                                                AutoGenerateColumns="False" EmptyDataText="No Records Found" OnPageIndexChanging="gvStreet_PageIndexChanging"
                                                OnRowCommand="gvStreet_RowCommand" OnRowDataBound="gvStreet_RowDataBound" OnSorting="gvStreet_Sorting"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Edit">
                                                        <ItemTemplate>
                                                            <asp:ImageButton ID="lnkedit" runat="server" CausesValidation="False" CommandArgument='<%# Eval("StreetId") %>'
                                            ...
                                            <asp:HiddenField ID="hfStreetId" runat="server" />
