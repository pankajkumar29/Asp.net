<%@ Page Title="Nationality" Language="C#" MasterPageFile="~/Application/Common/Common.Master"
    AutoEventWireup="true" CodeFile="Master_Nationality.aspx.cs" Inherits="DhiiLifeSpring.Application.Masters.Master_Nationality"
...
<asp:Content ID="Content2" ContentPlaceHolderID="bodyContentPlaceHolder" runat="server">
    <script type="text/javascript" language="javascript">
        ...
        function onModalPopupShown() {
            $get("<%=txtNationality.ClientID%>").focus();
        }
        function onKeyDown(e) {
            if (e && e.keyCode == Sys.UI.Key.esc) {
                $find('mdlPopup').hide();
                document.getElementById('<%=btnAddNationality.ClientID %>').focus();
            }
        }
        function AddClick() {
            var msg = document.getElementById('<%=lblMsg.ClientID %>');
            if (document.getElementById('<%=txtNationality.ClientID%>').value.trim() == "") {
                msg.innerHTML = "Required nationality";
                msg.style.color = "red";
        ...
        <ContentTemplate>
                                        ...
                                        <table width="100%" style="text-align: center">
                                            <tr>
                                                <td valign="middle" class="mdpopup-header">
                                                    <asp:Label ID="lblmdlheadertext" runat="server" Text="Add/Update Nationality"></asp:Label>
                                                </td>
                                            </tr>
                                            <tr>
                                                    ...
                                                    <table width="80%" align="center">
                                                        ...
                                                        <tr>
                                                            <td align="left" style="padding-top: 5px;">
                                                                <span class="star">*</span><asp:Label ID="lblNationality" runat="server" Text="Nationality:"></asp:Label>
                                                            </td>
                                                            <td align="left" style="padding-top: 5px;">
                                                                <asp:TextBox ID="txtNationality" runat="server" SkinID="Txt_Skin" MaxLength="50" onfocus="Change(this, event)"
                                                                    onblur="Change(this, event)" onkeyup="return CheckFirstChar(this);"></asp:TextBox>
                                                                <ajaxToolkit:FilteredTextBoxExtender ID="fteNationality" runat="server" TargetControlID="txtNationality"
            ...
            <fieldset style="border: 1px dashed #ccc; margin-left: 10px; margin-top: 0px; text-align: right;
                ...
                <legend class="legend_right" style="margin-right: 10px;" align="right">
                    <asp:Label ID="lblDoc" runat="server" Text="Nationality"></asp:Label>
                </legend>
                <table width="100%">
                    <tr>
                        <td align="center">
                            <table width="98%" style="text-align: center;" cellpadding="0" cellspacing="0">
                                <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <ajaxToolkit:AutoCompleteExtender ID="aceSearch" runat="server" BehaviorID="bidSearch"
                                                        ...
                                                        CompletionSetCount="20" MinimumPrefixLength="1" ServiceMethod="GetAllNationality"
                                                    ...
                                                    <ajaxToolkit:TextBoxWatermarkExtender ID="wmeSearch" runat="server" TargetControlID="txtSearch"
                                                        WatermarkCssClass="watermarked" WatermarkText="Nationality">
                                    ...
                                    <td align="right" style="padding-bottom: 10px">
                                        <asp:Button ID="btnAddNationality" runat="server" CssClass="button_Add" Text="Add New"
                                            ToolTip="Add New" CausesValidation="False" OnClick="btnAddNationality_Click"  />
                                    </td>
                                </tr>
                                <tr>
                                    <td align="center" colspan="2">
                                        <asp:GridView ID="gvNationality" runat="server" AutoGenerateColumns="False" AllowPaging="True"
                                            AllowSorting="True" EmptyDataText="No Records Found" OnPageIndexChanging="gvNationality_PageIndexChanging"
                                            OnRowCommand="gvNationality_RowCommand" OnRowDataBound="gvNationality_RowDataBound" OnSorting="gvNationality_Sorting"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Nationality" SortExpression="Nationality">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblNationalityName" runat="server" Text='<%# Eval("Nationality") %>'></asp:Label>
                                                    </ItemTemplate>
                                                ...
                                                <asp:TemplateField HeaderText="Edit">
                                                    <ItemTemplate>
                                                        <asp:ImageButton ID="lnkedit" runat="server" CausesValidation="False" CommandArgument='<%# Eval("NationalityId") %>'
