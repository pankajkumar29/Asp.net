<%@ Page Title="Package Cost" Language="C#" AutoEventWireup="true" CodeFile="Master_PackageCost.aspx.cs"
    MasterPageFile="~/Application/Common/Common.Master" StylesheetTheme="Controls"
    Inherits="DhiiLifeSpring.Application.Masters.Master_PackageCost" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="bodyContentPlaceHolder" runat="server">
    <script type="text/JavaScript" language="JavaScript">
        ...
        function SaveServiceCost() {
            ...
            if (document.getElementById('<%=ddlServices.ClientID %>').selectedIndex == 0) {
                var msg = document.getElementById('<%=lblError.ClientID %>');
                msg.innerHTML = "Select Package";
                msg.style.color = "red";
                $get("<%=ddlServices.ClientID%>").focus();
                return false;
            }
        }
        ...
        <ContentTemplate>
            ...
            <fieldset style="border: 1px dashed #ccc; margin-left: 10px; margin-top: 0px; text-align: right;
                ...
                <legend class="legend_right" style="margin-right: 10px;" align="right">
                    <asp:Label ID="lblDoc" runat="server" Text=" Package Cost"></asp:Label>
                </legend>
                <table width="100%">
                    <tr>
                    ...
                    <tr>
                        <td align="left">
                            <span class="star">*</span><asp:Label ID="lblServiceType" SkinID="Lbl_Verdana" runat="server"
                                Text="Service Group:" Width="130"></asp:Label>
                        </td>
                        <td align="left">
                        ...
                        <td align="left">
                            <span class="star">*</span><asp:Label ID="lblService0" runat="server" SkinID="Lbl_Verdana" Text="Package:"></asp:Label>
                        </td>
                        <td align="left">
                            <asp:DropDownList ID="ddlServices" runat="server" AutoPostBack="true" onblur="Change(this, event)"
                                onfocus="Change(this, event)" 
                                SkinID="Dpd_Skin" Width="200px" Height="20px" /> <%--OnSelectedIndexChanged="ddlServices_SelectedIndexChanged"--%>
                        </td>
                    </tr>
                    <tr>
                            ...
                            <div style="width: 650px; height: auto; overflow: scroll;">
                                <asp:GridView ID="gvServiceCost" runat="server" AutoGenerateColumns="False" SkinID="GridTransactions"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Ward" ItemStyle-Width="200px" ItemStyle-HorizontalAlign="Left">
                                            <ItemTemplate>
                                                <asp:Label ID="lblWardId" runat="server" Visible="false" Text='<%# BIND("WardId") %>'></asp:Label>
                                                <asp:Label ID="lblWard" runat="server" Text='<%# BIND("Ward") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
                                </asp:GridView>
                    ...
                    <tr>
                        ...
                        <td align="left" colspan="2" >
                            <asp:CheckBoxList ID="ChkBranch" runat="server" RepeatColumns="2" Width="300px">
                            </asp:CheckBoxList>
                        </td>
                    </tr>
                    <tr>
