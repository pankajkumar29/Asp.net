<%@ Page Title="Credit Company" Language="C#" MasterPageFile="~/Application/Common/Common.Master"
    AutoEventWireup="true" CodeFile="Master_CreditCompany.aspx.cs" Inherits="DhiiLifeSpring.Application.Masters.Master_CreditCompany"
...
<asp:Content ID="Content1" ContentPlaceHolderID="headContentPlaceHolder" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        function onModalPopupShown() {
            $get("<%=txtCreditCompany.ClientID%>").focus();
        }
        function onKeyDown(e) {
            if (e && e.keyCode == Sys.UI.Key.esc) {
                $find('mdlPopup').hide();
                document.getElementById('<%=btnAddCreditCompany.ClientID %>').focus();
            }
        }
        function AddClcik() {
            var msg = document.getElementById('<%=lblMsg.ClientID %>');
            if (document.getElementById('<%=txtCreditCompany.ClientID%>').value.trim() == "") {
                msg.innerHTML = "Required credit company";
                msg.style.color = "red";
                document.getElementById('<%=txtCreditCompany.ClientID%>').focus();
                return false;
            }
        ...
        <ContentTemplate>
                                        ...
                                        <table width="100%" style="text-align: center">
                                            <tr>
                                                <td valign="middle" class="mdpopup-header">
                                                    <asp:Label ID="lblmdlheadertext" runat="server" Text="Add/Update Credit Company"></asp:Label>
                                                </td>
                                            </tr>
                                            <tr>
                                                    ...
                                                    <table width="80%" align="center">
                                                        ...
                                                        <tr>
                                                            <td align="left" style="padding-top: 5px;">
                                                                <span class="star">*</span><asp:Label ID="lblCreditCompany" runat="server" Text="Credit Company:"></asp:Label>
                                                            </td>
                                                            <td align="left" style="padding-top: 5px;">
                                                                <asp:TextBox ID="txtCreditCompany" runat="server" SkinID="Txt_Skin" MaxLength="50"
                                                                    onfocus="Change(this, event)" onblur="Change(this, event)" onkeyup="CheckFirstChar(this);"></asp:TextBox>
                                                                <ajaxToolkit:FilteredTextBoxExtender ID="fteCreditCompany" runat="server" TargetControlID="txtCreditCompany"
            ...
            <fieldset style="border: 1px dashed #ccc; margin-left: 10px; margin-top: 0px; text-align: right;
                ...
                <legend class="legend_right" style="margin-right: 10px;" align="right">
                    <asp:Label ID="lblDoc" runat="server" Text="Credit Company"></asp:Label>
                </legend>
                <table width="100%">
                    <tr>
                        <td align="center">
                            <table width="98%" style="text-align: center;" cellpadding="0" cellspacing="0">
                                <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <ajaxToolkit:AutoCompleteExtender ID="aceSearch" runat="server" BehaviorID="bidSearch"
                                                        ...
                                                        ServiceMethod="GetAllCreditCompany" TargetControlID="txtSearch" DelimiterCharacters="">
                                                    ...
                                                    <ajaxToolkit:TextBoxWatermarkExtender ID="wmeSearch" runat="server" TargetControlID="txtSearch"
                                                        WatermarkCssClass="watermarked" WatermarkText="Credit Company">
                                    ...
                                    <td align="right" style="padding-bottom: 10px;">
                                        <asp:Button ID="btnAddCreditCompany" runat="server" CssClass="button_Add" Text="Add New"
                                            ToolTip="Add New" CausesValidation="False" OnClick="btnAddCreditCompany_Click"
                                             />
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="2" align="center" valign="top">
                                        <asp:GridView ID="gvCreditCompany" runat="server" SkinID="GridMasters" AutoGenerateColumns="False"
                                            AllowPaging="True" PageSize="15" AllowSorting="True" EmptyDataText="No Records Found"
                                            OnPageIndexChanging="gvCreditCompany_PageIndexChanging" OnRowCommand="gvCreditCompany_RowCommand"
                                            OnRowDataBound="gvCreditCompany_RowDataBound" OnSorting="gvCreditCompany_Sorting"
                                            Width="100%">
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Credit Company" SortExpression="CreditCompany">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblCreditCompany" runat="server" Text='<%# Eval("CreditCompany") %>'></asp:Label>
                                                    </ItemTemplate>
                                                ...
                                                <asp:TemplateField HeaderText="Edit">
                                                    <ItemTemplate>
                                                        <asp:ImageButton ID="lnkedit" runat="server" CausesValidation="False" CommandArgument='<%# Eval("CreditCompanyId") %>'
                                        ...
                                        <asp:HiddenField ID="hfCreditCompanyId" runat="server" />
