<%@ Page Title="Service Main Group" Language="C#" MasterPageFile="~/Application/Common/Common.Master"
    AutoEventWireup="true" CodeFile="Master_ServiceMainGroup.aspx.cs" Inherits="DhiiLifeSpring.Application.Masters.Master_ServiceMainGroup"
...
<asp:Content ID="Content1" ContentPlaceHolderID="headContentPlaceHolder" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        function onModalPopupShown() {
            $get("<%=txtMainGroup.ClientID%>").focus();
        }
        function onKeyDown(e) {
            if (e && e.keyCode == Sys.UI.Key.esc) {
                $find('mdlPopup').hide();
                document.getElementById('<%=btnAddMainGroup.ClientID %>').focus();
            }
        }
        function AddClcik() {
            var msg = document.getElementById('<%=lblMsg.ClientID %>');
            if (document.getElementById('<%=txtMainGroup.ClientID%>').value.trim() == "") {
                msg.innerHTML = "Required main group";
                msg.style.color = "red";
                document.getElementById('<%=txtMainGroup.ClientID%>').focus();
                return false;
            }
            if (document.getElementById('<%=txtMainGroup.ClientID%>').value.length < 2) {
        ...
        <ContentTemplate>
                                        ...
                                        <table width="100%" style="text-align: center">
                                            <tr>
                                                <td valign="middle" class="mdpopup-header">
                                                    <asp:Label ID="lblmdlheadertext" runat="server" Text="Add/Update Service Main Group"></asp:Label>
                                                </td>
                                            </tr>
                                            <tr>
                                                    ...
                                                    <table width="80%" align="center">
                                                        ...
                                                        <tr>
                                                            <td align="left" style="padding-top: 5px;">
                                                                <span class="star">*</span><asp:Label ID="lblMainGroup" runat="server" Text="Main Group:"></asp:Label>
                                                            </td>
                                                            <td align="left" style="padding-top: 5px;">
                                                                <asp:TextBox ID="txtMainGroup" runat="server" SkinID="Txt_Skin" MaxLength="20" onfocus="Change(this, event)"
                                                                    onblur="Change(this, event)" onkeyup="CheckFirstChar(this);"></asp:TextBox>
                                                                <ajaxToolkit:FilteredTextBoxExtender ID="fteMainGroup" runat="server" TargetControlID="txtMainGroup"
            ...
            <fieldset style="border: 1px dashed #ccc; margin-left: 10px; margin-top: 0px; text-align: right;
                ...
                <legend class="legend_right" style="margin-right: 10px;" align="right">
                    <asp:Label ID="lblDoc" runat="server" Text="Service Main Group"></asp:Label>
                </legend>
                <table width="100%">
                    <tr>
                        <td align="center">
                            <table width="98%" style="text-align: center;" cellpadding="0" cellspacing="0">
                                <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <ajaxToolkit:AutoCompleteExtender ID="aceSearch" runat="server" BehaviorID="bidSearch"
                                                        ...
                                                        ServiceMethod="GetAllMainGroups" TargetControlID="txtSearch" DelimiterCharacters="">
                                                    ...
                                                    <ajaxToolkit:TextBoxWatermarkExtender ID="wmeSearch" runat="server" TargetControlID="txtSearch"
                                                        WatermarkCssClass="watermarked" WatermarkText="Main Group">
                                    ...
                                    <td align="right" style="padding-bottom: 10px;">
                                        <asp:Button ID="btnAddMainGroup" runat="server" CssClass="button_Add" Text="Add New"
                                            ToolTip="Add New" CausesValidation="False" OnClick="btnAddMainGroup_Click"  />
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="2" align="center">
                                        <asp:GridView ID="gvMainGroup" runat="server" SkinID="GridMasters" AutoGenerateColumns="False"
                                            AllowPaging="True" PageSize="15" AllowSorting="True" EmptyDataText="No Records Found"
                                            OnPageIndexChanging="gvMainGroup_PageIndexChanging" OnRowCommand="gvMainGroup_RowCommand"
                                            OnRowDataBound="gvMainGroup_RowDataBound" OnSorting="gvMainGroup_Sorting" Width="100%">
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Main Group" SortExpression="ServiceMainGroup">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblMainGroupName" runat="server" Text='<%# Eval("ServiceMainGroup") %>'></asp:Label>
                                                    </ItemTemplate>
                                                ...
                                                <asp:TemplateField HeaderText="Edit">
                                                    <ItemTemplate>
                                                        <asp:ImageButton ID="lnkedit" runat="server" CausesValidation="False" CommandArgument='<%# Eval("ServiceMainGroupId") %>'
                                        ...
                                        <asp:HiddenField ID="hfMainGroupId" runat="server" />
