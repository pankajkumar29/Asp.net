<%@ Page Title="Religion" Language="C#" MasterPageFile="~/Application/Common/Common.Master"
    AutoEventWireup="true" CodeFile="Master_Religion.aspx.cs" Inherits="DhiiLifeSpring.Application.Masters.Master_Religion"
...
<asp:Content ID="Content2" ContentPlaceHolderID="bodyContentPlaceHolder" runat="server">
    <script type="text/javascript" language="javascript">
        ...
        function onModalPopupShown() {
            $get("<%=txtReligion.ClientID%>").focus();
        }
        function onKeyDown(e) {
            if (e && e.keyCode == Sys.UI.Key.esc) {
                $find('mdlPopup').hide();
                document.getElementById('<%=btnAddReligion.ClientID %>').focus();
            }
        }
        function AddClick() {
            var msg = document.getElementById('<%=lblMsg.ClientID %>');
            if (document.getElementById('<%=txtReligion.ClientID%>').value.trim() == "") {
                msg.innerHTML = "Required religion";
                msg.style.color = "red";
        ...
        <ContentTemplate>
                                        ...
                                        <table width="100%" style="text-align: center">
                                            <tr>
                                                <td valign="middle" class="mdpopup-header">
                                                    <asp:Label ID="lblmdlheadertext" runat="server" Text="Add/Update Religion"></asp:Label>
                                                </td>
                                            </tr>
                                            <tr>
                                                    ...
                                                    <table width="80%" align="center">
                                                        ...
                                                        <tr>
                                                            <td align="left" style="padding-top: 5px;">
                                                                <span class="star">*</span><asp:Label ID="lblReligion" runat="server" Text="Religion:"></asp:Label>
                                                            </td>
                                                            <td align="left" style="padding-top: 5px;">
                                                                <asp:TextBox ID="txtReligion" runat="server" SkinID="Txt_Skin" MaxLength="50" onfocus="Change(this, event)"
                                                                    onblur="Change(this, event)" onkeyup="return CheckFirstChar(this);"></asp:TextBox>
                                                                <ajaxToolkit:FilteredTextBoxExtender ID="fteReligion" runat="server" TargetControlID="txtReligion"
            ...
            <fieldset style="border: 1px dashed #ccc; margin-left: 10px; margin-top: 0px; text-align: right;
                ...
                <legend class="legend_right" style="margin-right: 10px;" align="right">
                    <asp:Label ID="lblDoc" runat="server" Text="Religion"></asp:Label>
                </legend>
                <table width="100%">
                    <tr>
                        <td align="center">
                            <table width="98%" style="text-align: center;" cellpadding="0" cellspacing="0">
                                <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <ajaxToolkit:AutoCompleteExtender ID="aceSearch" runat="server" BehaviorID="bidSearch"
                                                        ...
                                                        CompletionSetCount="20" MinimumPrefixLength="1" ServiceMethod="GetAllReligion"
                                                    ...
                                                    <ajaxToolkit:TextBoxWatermarkExtender ID="wmeSearch" runat="server" TargetControlID="txtSearch"
                                                        WatermarkCssClass="watermarked" WatermarkText="Religion">
                                    ...
                                    <td align="right" style="padding-bottom: 10px">
                                        <asp:Button ID="btnAddReligion" runat="server" CssClass="button_Add" Text="Add New"
                                            ToolTip="Add New" CausesValidation="False" OnClick="btnAddReligion_Click"  />
                                    </td>
                                </tr>
                                <tr>
                                    <td align="center" colspan="2">
                                        <asp:GridView ID="gvReligion" runat="server" AutoGenerateColumns="False" AllowPaging="True"
                                            AllowSorting="True" EmptyDataText="No Records Found" OnPageIndexChanging="gvReligion_PageIndexChanging"
                                            OnRowCommand="gvReligion_RowCommand" OnRowDataBound="gvReligion_RowDataBound"
                                            OnSorting="gvReligion_Sorting" PageSize="15" SkinID="GridMasters" Width="100%">
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Religion" SortExpression="Religion">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblReligionName" runat="server" Text='<%# Eval("Religion") %>'></asp:Label>
                                                    </ItemTemplate>
                                                ...
                                                <asp:TemplateField HeaderText="Edit">
                                                    <ItemTemplate>
                                                        <asp:ImageButton ID="lnkedit" runat="server" CausesValidation="False" CommandArgument='<%# Eval("ReligionId") %>'
