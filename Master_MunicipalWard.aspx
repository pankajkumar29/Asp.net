<%@ Page Title="Municipal Ward" Language="C#" MasterPageFile="~/Application/Common/Common.Master"
    AutoEventWireup="true" CodeFile="Master_MunicipalWard.aspx.cs" Inherits="DhiiLifeSpring.Application.Masters.Master_MunicipalWard"
    ...
    <script type="text/javascript" language="javascript">
        ...
        function onKeyDown(e) {
            if (e && e.keyCode == Sys.UI.Key.esc) {
                $find('mdlPopup').hide();
                document.getElementById('<%=btnAddMunicipalWard.ClientID %>').focus();
            }
        }
        function AddClick() {
            ...
            if (document.getElementById('<%=txtMunicipalWard.ClientID %>').value.trim() == "") {
                msg.innerHTML = "Required municipal ward";
                msg.style.color = "red";
                document.getElementById('<%=txtMunicipalWard.ClientID %>').focus();
                return false;
            }
        ...
        <ContentTemplate>
                                        ...
                                        <table width="100%" style="text-align: center">
                                            <tr>
                                                <td valign="middle" class="mdpopup-header">
                                                    <asp:Label ID="lblmdlheadertext" runat="server" Text="Add/Update Municipal Ward"></asp:Label>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="center">
                                                    <table width="80%">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="left" style="padding-top: 5px;">
                                                                <asp:TextBox ID="txtMunicipalWard" runat="server" SkinID="Txt_Skin" MaxLength="50"
                                                                    onfocus="Change(this, event)" onblur="Change(this, event)" onkeyup="return CheckFirstChar(this);"></asp:TextBox>
                                                                <ajaxToolkit:FilteredTextBoxExtender ID="fteMunicipalWard" runat="server" TargetControlID="txtMunicipalWard"
            ...
            <fieldset style="border: 1px dashed #ccc; margin-left: 10px; margin-top: 0px; text-align: right;
                ...
                <legend class="legend_right" style="margin-right: 10px;" align="right">
                    <asp:Label ID="lblDoc" runat="server" Text="Municipal Ward"></asp:Label>
                </legend>
                <table width="100%">
                    <tr>
                        <td align="center">
                                ...
                                <caption>
                                    <tr>
                                            ...
                                            <table>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <ajaxToolkit:AutoCompleteExtender ID="aeSearch" runat="server" BehaviorID="bidSearch"
                                                            CompletionInterval="500" CompletionListCssClass="autocomplete_completionListElement"
                                                            CompletionListHighlightedItemCssClass="autocomplete_highlightedListItem" CompletionListItemCssClass="autocomplete_ListItem"
                                                            CompletionSetCount="20" MinimumPrefixLength="1" ServiceMethod="GetAllMunicipalWards"
                                                            ServicePath="~/DhiiCommonService.asmx" TargetControlID="txtSearch" DelimiterCharacters="">
                                                        </ajaxToolkit:AutoCompleteExtender>
                                                        <ajaxToolkit:FilteredTextBoxExtender ID="fltSearch" runat="server" TargetControlID="txtSearch"
                                                            FilterMode="InvalidChars" InvalidChars=";|~!@#$%^&*<>/\{}:;/*-+_?~`[]=1234567890&quot;">
                                                        </ajaxToolkit:FilteredTextBoxExtender>
                                                        <ajaxToolkit:TextBoxWatermarkExtender ID="txtwSearch" runat="server" TargetControlID="txtSearch"
                                                            WatermarkCssClass="watermarked" WatermarkText="Municipal Ward">
                                        ...
                                        <td align="right" style="padding-bottom: 10px">
                                            <asp:Button ID="btnAddMunicipalWard" runat="server" CssClass="button_Add" Text="Add New"
                                                ToolTip="Add New" CausesValidation="False" OnClick="btnAddMunicipalWard_Click"
                                                 />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="center" colspan="2">
                                            <asp:GridView ID="gvMunicipalWard" runat="server" SkinID="GridMasters" AutoGenerateColumns="False"
                                                AllowPaging="True" AllowSorting="True" EmptyDataText="No Records Found" OnPageIndexChanging="gvMunicipalWard_PageIndexChanging"
                                                OnRowCommand="gvMunicipalWard_RowCommand" OnRowDataBound="gvMunicipalWard_RowDataBound"
                                                OnSorting="gvMunicipalWard_Sorting" PageSize="15" Width="100%">
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Municipal Ward" SortExpression="MunicipalWard">
                                                        <ItemTemplate>
                                                    ...
                                                    <asp:TemplateField HeaderText="Edit">
                                                        <ItemTemplate>
                                                            <asp:ImageButton ID="lnkedit" runat="server" CausesValidation="False" CommandArgument='<%# Eval("MunicipalWardId") %>'
                                            ...
                                            <asp:HiddenField ID="hfMunicipalWardId" runat="server" />
