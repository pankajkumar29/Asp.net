<%@ Page Title="Tariff" Language="C#" MasterPageFile="~/Application/Common/Common.Master"
    AutoEventWireup="true" CodeFile="Master_Tariff.aspx.cs" Inherits="DhiiLifeSpring.Application.Masters.Master_Tariff"
...
<asp:Content ID="Content2" ContentPlaceHolderID="bodyContentPlaceHolder" runat="server">
    <script type="text/javascript" language="javascript">
        ...
        function onModalPopupShown() {
            $get("<%=txtTariff.ClientID%>").focus();
        }
        function onKeyDown(e) {
            if (e && e.keyCode == Sys.UI.Key.esc) {
                $find('mdlPopup').hide();
                document.getElementById('<%=btnAddTariff.ClientID %>').focus();
            }
        }
        function AddClick() {
            var msg = document.getElementById('<%=lblMsg.ClientID %>');
            if (document.getElementById('<%=txtTariff.ClientID%>').value.trim() == "") {
                msg.innerHTML = "Required Tariff";
                msg.style.color = "red";
                document.getElementById('<%=txtTariff.ClientID%>').focus();
                return false;
            }
        ...
        <ContentTemplate>
                                        ...
                                        <table width="100%" style="text-align: center">
                                            <tr>
                                                <td valign="middle" class="mdpopup-header">
                                                    <asp:Label ID="lblmdlheadertext" runat="server" Text="Add/Update Tariff"></asp:Label>
                                                </td>
                                            </tr>
                                            <tr>
                                                    ...
                                                    <table width="80%" align="center">
                                                        ...
                                                        <tr>
                                                            <td align="left" style="padding-top: 5px;">
                                                                <span class="star">*</span><asp:Label ID="lblTariff" runat="server" Text="Tariff:"></asp:Label>
                                                            </td>
                                                            <td align="left" style="padding-top: 5px;">
                                                                <asp:TextBox ID="txtTariff" runat="server" SkinID="Txt_Skin" MaxLength="50" onfocus="Change(this, event)"
                                                                    onblur="Change(this, event)" onkeyup="return CheckFirstChar(this);"></asp:TextBox>
                                                                <ajaxToolkit:FilteredTextBoxExtender ID="fteTariff" runat="server" TargetControlID="txtTariff"
                                                        ...
                                                        <tr>
                                                            <td align="center" colspan="2" style="padding-top: 10px;">
                                                                <asp:CheckBox ID="chkIsCredit" runat="server" Text="Is Credit" />
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td align="center" colspan="2" style="padding-top: 10px;">
            ...
            <fieldset style="border: 1px dashed #ccc; margin-left: 10px; margin-top: 0px; text-align: right;
                ...
                <legend class="legend_right" style="margin-right: 10px;" align="right">
                    <asp:Label ID="lblDoc" runat="server" Text="Tariff"></asp:Label>
                </legend>
                <table width="100%">
                    <tr>
                        <td align="center">
                            <table width="98%" style="text-align: center;" cellpadding="0" cellspacing="0">
                                <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <ajaxToolkit:AutoCompleteExtender ID="aceSearch" runat="server" BehaviorID="bidSearch"
                                                        ...
                                                        CompletionSetCount="20" MinimumPrefixLength="1" ServiceMethod="GetAllTariff"
                                                    ...
                                                    <ajaxToolkit:TextBoxWatermarkExtender ID="wmeSearch" runat="server" TargetControlID="txtSearch"
                                                        WatermarkCssClass="watermarked" WatermarkText="Tariff">
                                    ...
                                    <td align="right" style="padding-bottom: 10px">
                                        <asp:Button ID="btnAddTariff" runat="server" CssClass="button_Add" Text="Add New"
                                            ToolTip="Add New" CausesValidation="False" OnClick="btnAddTariff_Click" 
                                            Visible="false" />
                                    </td>
                                </tr>
                                <tr>
                                    <td align="center" colspan="2">
                                        <asp:GridView ID="gvTariff" runat="server" AutoGenerateColumns="False" AllowPaging="True"
                                            AllowSorting="True" EmptyDataText="No Records Found" OnPageIndexChanging="gvTariff_PageIndexChanging"
                                            OnRowCommand="gvTariff_RowCommand" OnRowDataBound="gvTariff_RowDataBound" OnSorting="gvTariff_Sorting"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Tariff" SortExpression="Tariff" HeaderStyle-Width="350px">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblTariffName" runat="server" Text='<%# Eval("Tariff") %>'></asp:Label>
                                                    </ItemTemplate>
                                                    <HeaderStyle CssClass="headerBorderLine" />
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="Is Credit" HeaderStyle-Width="100px">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblIsCredit" runat="server" Text='<%# (bool)Eval("IsCredit")?"Yes":"No" %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                ...
                                                <asp:TemplateField HeaderText="Edit" Visible="false">
                                                    <ItemTemplate>
                                                        <asp:ImageButton ID="lnkedit" runat="server" CausesValidation="False" CommandArgument='<%# Eval("TariffId") %>'
                                        ...
                                        <asp:HiddenField ID="hfTariffId" runat="server" />
