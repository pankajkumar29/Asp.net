<%@ Page Title="Occupation" Language="C#" MasterPageFile="~/Application/Common/Common.Master"
    AutoEventWireup="true" CodeFile="Master_Occupation.aspx.cs" Inherits="DhiiLifeSpring.Application.Masters.Master_Occupation"
...
<asp:Content ID="Content2" ContentPlaceHolderID="bodyContentPlaceHolder" runat="server">
    <script type="text/javascript" language="javascript">
        ...
        function onModalPopupShown() {
            $get("<%=txtOccupation.ClientID%>").focus();
        }
        function onKeyDown(e) {
            if (e && e.keyCode == Sys.UI.Key.esc) {
                $find('mdlPopup').hide();
                document.getElementById('<%=btnAddOccupation.ClientID %>').focus();
            }
        }
        function AddClick() {
            var msg = document.getElementById('<%=lblMsg.ClientID %>');
            if (document.getElementById('<%=txtOccupation.ClientID%>').value.trim() == "") {
                msg.innerHTML = "Required occupation";
                msg.style.color = "red";
        ...
        <ContentTemplate>
                                        ...
                                        <table width="100%" style="text-align: center">
                                            <tr>
                                                <td valign="middle" class="mdpopup-header">
                                                    <asp:Label ID="lblmdlheadertext" runat="server" Text="Add/Update Occupation"></asp:Label>
                                                </td>
                                            </tr>
                                            <tr>
                                                    ...
                                                    <table width="80%" align="center">
                                                        ...
                                                        <tr>
                                                            <td align="left" style="padding-top: 5px;">
                                                                <span class="star">*</span><asp:Label ID="lblOccupation" runat="server" Text="Occupation:"></asp:Label>
                                                            </td>
                                                            <td align="left" style="padding-top: 5px;">
                                                                <asp:TextBox ID="txtOccupation" runat="server" SkinID="Txt_Skin" MaxLength="50" onfocus="Change(this, event)"
                                                                    onblur="Change(this, event)" onkeyup="return CheckFirstChar(this);"></asp:TextBox>
                                                                <ajaxToolkit:FilteredTextBoxExtender ID="fteOccupation" runat="server" TargetControlID="txtOccupation"
            ...
            <fieldset style="border: 1px dashed #ccc; margin-left: 10px; margin-top: 0px; text-align: right;
                ...
                <legend class="legend_right" style="margin-right: 10px;" align="right">
                    <asp:Label ID="lblDoc" runat="server" Text="Occupation"></asp:Label>
                </legend>
                <table width="100%">
                    <tr>
                        <td align="center">
                            <table width="98%" style="text-align: center;" cellpadding="0" cellspacing="0">
                                <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <ajaxToolkit:AutoCompleteExtender ID="aceSearch" runat="server" BehaviorID="bidSearch"
                                                        ...
                                                        CompletionSetCount="20" MinimumPrefixLength="1" ServiceMethod="GetAllOccupation"
                                                    ...
                                                    <ajaxToolkit:TextBoxWatermarkExtender ID="wmeSearch" runat="server" TargetControlID="txtSearch"
                                                        WatermarkCssClass="watermarked" WatermarkText="Occupation">
                                    ...
                                    <td align="right" style="padding-bottom: 10px">
                                        <asp:Button ID="btnAddOccupation" runat="server" CssClass="button_Add" Text="Add New"
                                            ToolTip="Add New" CausesValidation="False" OnClick="btnAddOccupation_Click"  />
                                    </td>
                                </tr>
                                <tr>
                                    <td align="center" colspan="2">
                                        <asp:GridView ID="gvOccupation" runat="server" AutoGenerateColumns="False" AllowPaging="True"
                                            AllowSorting="True" EmptyDataText="No Records Found" OnPageIndexChanging="gvOccupation_PageIndexChanging"
                                            OnRowCommand="gvOccupation_RowCommand" OnRowDataBound="gvOccupation_RowDataBound" OnSorting="gvOccupation_Sorting"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Occupation" SortExpression="Occupation">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblOccupationName" runat="server" Text='<%# Eval("Occupation") %>'></asp:Label>
                                                    </ItemTemplate>
                                                ...
                                                <asp:TemplateField HeaderText="Edit">
                                                    <ItemTemplate>
                                                        <asp:ImageButton ID="lnkedit" runat="server" CausesValidation="False" CommandArgument='<%# Eval("OccupationId") %>'
                                        ...
                                        <asp:HiddenField ID="hfOccupationId" runat="server" />
